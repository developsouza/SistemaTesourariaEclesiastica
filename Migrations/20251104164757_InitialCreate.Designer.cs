...
namespace SistemaTesourariaEclesiastica.Migrations
{
    ...
    [Migration("20251104164757_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaTesourariaEclesiastica.Models.DespesaRecorrente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CentroCustoId", "Ativa")
            ...
            modelBuilder.Entity("SistemaTesourariaEclesiastica.Models.Entrada", b =>
                {
                    ...
                    b.Property<DateTime?>("DataInclusaoFechamento")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int?>("FechamentoQueIncluiuId")
                        .HasColumnType("int");

                    b.Property<bool>("IncluidaEmFechamento")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("FechamentoQueIncluiuId");
            ...
            modelBuilder.Entity("SistemaTesourariaEclesiastica.Models.FechamentoPeriodo", b =>
                {
                    ...
                    b.Property<bool>("EhFechamentoSede")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("QuantidadeCongregacoesIncluidas")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaTesourariaEclesiastica.Models.PagamentoDespesaRecorrente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DespesaRecorrenteId", "DataVencimento")
                        .HasDatabaseName("IX_PagamentosDespesas_Despesa_Vencimento");

                    b.ToTable("PagamentosDespesasRecorrentes");
                });
            ...
            modelBuilder.Entity("SistemaTesourariaEclesiastica.Models.Entrada", b =>
                {
                    ...
                    b.HasOne("SistemaTesourariaEclesiastica.Models.FechamentoPeriodo", "FechamentoQueIncluiu")
                        .WithMany()
                        .HasForeignKey("FechamentoQueIncluiuId");
                    ...
                    b.Navigation("FechamentoQueIncluiu");
            ...
            modelBuilder.Entity("SistemaTesourariaEclesiastica.Models.PagamentoDespesaRecorrente", b =>
                {
                    b.HasOne("SistemaTesourariaEclesiastica.Models.DespesaRecorrente", "DespesaRecorrente")
                        .WithMany("Pagamentos")
                        .HasForeignKey("DespesaRecorrenteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SistemaTesourariaEclesiastica.Models.Saida", "Saida")
                        .WithMany()
